...
/**
 * Criteria class for the {@link com.myapp.domain.Company} entity. This class is used
 * in {@link com.myapp.web.rest.CompanyResource} to receive all the possible filtering options from
...
public class CompanyCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, personId, distinct);
    }
